...
This project enabled me to learn about sets and dictionaries in Python. I practiced using them with the `lambda`, `map`, `filter`, and `reduce` methods.


* [tests](./tests): Folder of test files. Given by Holberton School.
